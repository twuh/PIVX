Contributing to WORX Core
============================

The WORX Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/worx-project/worx/blob/master/doc/translation_process.md)
...
The following applies to code changes to the WORX Core project, and is not to be
confused with overall WORX Network Protocol consensus changes.

Whether a pull request is merged into WORX Core rests with the project merge
...
Patches that change WORX consensus rules are considerably more involved than
...
Where a patchset proposes to change the WORX consensus, it must have been
...
The project leader is the release manager for each WORX Core release.
