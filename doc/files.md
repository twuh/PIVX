...
worx.conf           | contains configuration settings for worxd or worx-qt
worxd.pid           | stores the process id of worxd while running
...
debug.log           | contains debug information and general logging generated by worxd or worx-qt
