...
public:
    ...
    int WorxBadBlockTime() const { return nWorxBadBlockTime; }
    int WorxBadBlocknBits() const { return nWorxBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nWorxBadBlockTime;
    unsigned int nWorxBadBlocknBits;
