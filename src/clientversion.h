...
#error Client version information missing: version is not defined by worx-config.h or in any other way
#endif
...
/**
 * worxd-res.rc includes this file, but it cannot cope with real c++ code.
