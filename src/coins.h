...
/** 
    ...
    ****Note - for WORX we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of worx coming in to a transaction
