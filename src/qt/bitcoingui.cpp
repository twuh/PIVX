...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a WORX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and worx: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zWORX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About WORX Core"), this);
    aboutAction->setStatusTip(tr("Show information about WORX Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for WORX"));
    ...
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified WORX addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the WORX Core help message to get a list with possible WORX command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WORX network", "", count));
}
