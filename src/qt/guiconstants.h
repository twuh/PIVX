...
/* Worxx GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "WORX"
#define QAPP_ORG_DOMAIN "worx.org"
#define QAPP_APP_NAME_DEFAULT "WORX-Qt"
#define QAPP_APP_NAME_TESTNET "WORX-Qt-testnet"
