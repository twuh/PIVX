...
public:
    ...
    void setZWorxControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzWORX_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzWORX_clicked();
    void on_pushButtonZWorxControl_clicked();
