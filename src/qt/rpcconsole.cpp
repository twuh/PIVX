                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzWORXPathCustom = GetArg("-zworxbackuppath", "");
    ...
    if(!strzWORXPathCustom.empty()) {
        ui->wallet_customzworxbackuppath->setText(QString::fromStdString(strzWORXPathCustom));
        ui->wallet_customzworxbackuppath_label->setVisible(true);
        ui->wallet_customzworxbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzWORXPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the WORX RPC console.") + "<br>" +
