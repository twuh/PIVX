...
#include "qt/worx/coincontrolworxwidget.h"
#include "qt/worx/forms/ui_coincontrolworxwidget.h"

CoinControlWorxWidget::CoinControlWorxWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlWorxWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select WORX Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("WORX");
    ...
    ui->labelValueAfter->setText("0.00 WORX");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 WORX");
    ui->labelValueFee->setText("0.00 WORX");
...
CoinControlWorxWidget::~CoinControlWorxWidget()
{
    delete ui;
}
