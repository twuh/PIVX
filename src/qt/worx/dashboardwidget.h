...
#include "qt/worx/furabstractlistitemdelegate.h"
...
#include "config/worx-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalWorx = 0;
    qint64 totalZworx = 0;
    QList<qreal> valuesWorx;
    QList<qreal> valueszWorx;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(WORXGUI* _window);
    ~DashboardWidget();
