...
#include "qt/worx/forms/ui_masternodeswidget.h"
#include "qt/worx/qtutils.h"
#include "qt/worx/mnrow.h"
#include "qt/worx/mninfodialog.h"

#include "qt/worx/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(WORXGUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:3300 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked(){
    if(verifyWalletUnlocked()) {
        if(walletModel->getBalance() <= (COIN * 5000)){
            inform(tr("Not enough balance to create a masternode, 10,000 WORX required."));
            return;
        }
        showHideOp(true);
