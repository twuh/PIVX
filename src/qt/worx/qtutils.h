...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, WORXGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, WORXGUI *gui, double posX = 3);
