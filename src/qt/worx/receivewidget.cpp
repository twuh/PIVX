...
#include "qt/worx/forms/ui_receivewidget.h"
...
ReceiveWidget::ReceiveWidget(WORXGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive WORX."));
