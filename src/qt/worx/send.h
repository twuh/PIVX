...
#include "qt/worx/contactsdropdown.h"
#include "qt/worx/sendmultirow.h"
#include "qt/worx/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(WORXGUI* parent);
    ~SendWidget();
...
private slots:
    void onWORXSelected(bool _isWORX);
    void onSendClicked();
...
private:
    ...
    bool sendZworx(QList<SendCoinsRecipient> recipients);
