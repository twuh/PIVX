...
#include "qt/worx/settings/settingsnetworkwidget.h"
#include "qt/worx/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/worx/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(WORXGUI* _window, QWidget *parent) :
