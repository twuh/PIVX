...
#ifndef WORX_CORE_NEW_GUI_WORXGUI_H
#define WORX_CORE_NEW_GUI_WORXGUI_H
...
#include "qt/worx/navmenuwidget.h"
#include "qt/worx/topbar.h"
#include "qt/worx/dashboardwidget.h"
#include "qt/worx/send.h"
#include "qt/worx/receivewidget.h"
#include "qt/worx/addresseswidget.h"
#include "qt/worx/privacywidget.h"
#include "qt/worx/masternodeswidget.h"
#include "qt/worx/snackbar.h"
...
/**
  WORX GUI main class. This class represents the main window of the WORX UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class WORXGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit WORXGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~WORXGUI();
...
#endif //WORX_CORE_NEW_GUI_WORXGUI_H
