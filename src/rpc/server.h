...
extern UniValue DoZworxSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzworxseed(const UniValue& params, bool fHelp);
extern UniValue getzworxseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzworx(const UniValue& params, bool fHelp);
extern UniValue dzworxstate(const UniValue& params, bool fHelp);
