...
#ifndef WORX_ZWORXTRACKER_H
#define WORX_ZWORXTRACKER_H
...
public:
    CzWORXTracker(std::string strWalletFile);
    ~CzWORXTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzWORXWallet* zWORXWallet = NULL);
