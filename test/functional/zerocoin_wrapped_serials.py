...
from fake_stake.base_test import WORX_FakeStakeTest

class zWORXwrappedSerialsTest(WORX_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zWORXs..." % DENOM_TO_USE)
